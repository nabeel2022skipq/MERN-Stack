...
function Features() {
    return (
        <div id='features'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 px-5 mt-10 cursor-pointer'>
                <Fade triggerOnce cascade damping={0.01}>

                    <div>
                        <div className='rounded-sm flex justify-center items-center shadow-lg bg-gray-900 hover:bg-gray-800 transform hover:scale-105 transition ease-in-out duration-700 space-x-5 py-5'>
                            ...
                            <p className='text-lg font-semibold text-gray-400'>Lorem Ipsum</p>
                        </div>
                    </div>
